...
#ifndef WIFI_SSID
	#define WIFI_SSID "XXXXXXXXXX" // Put you SSID and Password here
...
void publishMessage(bool ls)
{
  ...
  if(ls == true)
    mqtt.publish(LIGHT1_ENDPOINT, "ON"); // or publishWithQoS
  else
    mqtt.publish(LIGHT1_ENDPOINT, "OFF"); // or publishWithQoS
...
void startMqttClient()
{
	...
	mqtt.connect("esp8266smig", MQTT_USERNAME, MQTT_PWD);
